...
python run_pretrained_ours.py  --data_path /home/janus/iwbi-cip-datasets/shared/fastMRI/knee/singlecoil_val --timesteps 50 
python run_pretrained_ours.py  --data_path /home/janus/iwbi-cip-datasets/shared/fastMRI/knee/singlecoil_val --timesteps 50 --accelerations 8 
python run_pretrained_ours.py  --data_path /home/janus/iwbi-cip-datasets/shared/fastMRI/knee/singlecoil_val --timesteps 50 --mask_type equispaced
python run_pretrained_ours.py  --data_path /home/janus/iwbi-cip-datasets/shared/fastMRI/knee/singlecoil_val --timesteps 50 --accelerations 8 --mask_type equispaced
