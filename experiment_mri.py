...
from pl_modules.unet_module import UNet, ComplexUNetModule, ImageUNet, NormUnetModule
...
if __name__ == "__main__":
    print("Hello")
    run_name = "Normed_MyComplexUnet_" + datetime.now().strftime("%Y-%m-%d_%H:%M:%S")
