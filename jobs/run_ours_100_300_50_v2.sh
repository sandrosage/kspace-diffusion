...
#SBATCH --job-name=logs/eval_ours_100_300_50_v2
#SBATCH --export=NONE
...
python run_pretrained_ours.py  --data_path /home/janus/iwbi-cip-datasets/shared/fastMRI/knee/singlecoil_val --timesteps 50 --cgs --accelerations 8