    ...
    def test_step(self, batch, batch_idx):
        ...
        if batch_idx % 40:
            ...
            if self.output_dir is not None:
                ...
                plt.axis("off")
                plt.tight_layout()
                plt.savefig(self.output_dir / (str(fname[:-3]) +  "_" + str(slice_num) + ".png") , bbox_inches="tight", dpi=1000, pad_inches=0)
                plt.close()
...
def create_arg_parser():
    ...
    parser.add_argument(
        "--output_path",
        default="/home/atuin/b180dc/b180dc46/VarNet",
        type=Path,
        required=False,
...
if __name__ == "__main__":
    ...
    path = f"{args.mask_type}_{args.accelerations}_varnet.json"
